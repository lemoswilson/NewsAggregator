...
class FactMagScrapper:
    ...
    class NewsPage:
        def __init__(self, link, headline=None, author=None, date=None, text=None, img_link=None, content_images=None, content_links = None, iframe = None, tags=None, category=None, description = None):
            self.link = link
        ...
        def get_description(self):
            self.description = self.page_soup().find("div", {"class":"entry-content"}).find("strong").text
