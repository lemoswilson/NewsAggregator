...
class ResidentAdvisor:
    ...
    def get_popular_news(self): # returns a list of NewsPage objects
        ...
        for news in popular_news:
            ...
            description = news.find("p", {"class":"copy"})
    ...
    class NewsPage:
        ...
        def get_tags(self):
            self.tags = self.page_soup().find("div", {"class":"f16"}).text
            return self.tags
...
scrapper = ResidentAdvisor()
news_from = scrapper.get_news_from_to(n_of_days=2)
print(news_from[7])
# featured_news = scrapper.get_featured_news()
# print(featured_news.link)
# print(type(featured_news.page_soup()))
# featured_news.get_all()
# for item, value in featured_news.__dict__.items():
#     if item != "soup":
#         print(value)



# title // headline - featured_post_headline
# link - featured_post_link
# author - author
# image-link - featured_post_img
# date - date
# text - article_text
# content-images - article_img
# content-links - article_links
# iframe - article_iframe
# tags - categories.append(tags)
# RA ONLY: 
    # desciption
    # categories

# todo organizar a featured news from the news page
