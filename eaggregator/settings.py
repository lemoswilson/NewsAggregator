"""
Django settings for eaggregator project.
...
# SECRET_KEY = '$4ul46fb5ffprnfm44zy$bdw%b=x#bhoj=^ix77+v9&zv=7u$s'
SECRET_KEY = os.environ.get('SECRET_KEY')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['etuneapp1.herokuapp.com']
...
INSTALLED_APPS = [
    ...
    'pitchfork.apps.PitchforkConfig',
...
WSGI_APPLICATION = 'eaggregator.wsgi.application'
